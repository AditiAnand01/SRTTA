...
from inference_iqa import calculate_iqa_score
...
def quality_loss(img1,img2):
    """ IQA score difference loss """
    iqa_score1 = calculate_iqa_score(img1)
    iqa_score2 = calculate_iqa_score(img2)
    return torch.abs(iqa_score1 - iqa_score2).mean()
...
class SRTTA():
    ...
    def test_time_adaptation(self, train_loader, corruption=None):
        ...
        iqa_loss = self.quality_loss(out_student, out_student_gt.detach())
        print("iqa loss = ",iqa_loss)
